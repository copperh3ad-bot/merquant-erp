-- Mirror of migrations/up/0011_restore_supabase_default_grants.sql
...
-- That dropped the standard Supabase grants. RLS policies were
-- intact but useless — no role could even USE the schema. Result:
-- every REST call from a logged-in user returned 403
