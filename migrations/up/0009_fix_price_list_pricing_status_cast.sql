-- migrations/up/0009_fix_price_list_pricing_status_cast.sql
--
        ...
        LOOP
            IF v_row ->> 'item_code' = ANY(v_keys_arr) THEN
                ...
                VALUES (
                    ...
                    (CASE WHEN NULLIF(v_row ->> 'price_usd','') IS NOT NULL THEN 'active'::public.pricing_status_t ELSE 'pending'::public.pricing_status_t END),
                    true)
                ON CONFLICT (item_code) DO UPDATE
